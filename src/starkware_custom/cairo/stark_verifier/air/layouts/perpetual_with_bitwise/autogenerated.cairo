from starkware_custom.cairo.stark_verifier.air.layouts.perpetual_with_bitwise.global_values import (
    GlobalValues,
)
from starkware_custom.cairo.stark_verifier.air.oods import OodsGlobalValues
