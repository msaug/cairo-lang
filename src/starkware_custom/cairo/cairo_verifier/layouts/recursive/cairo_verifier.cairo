...
from starkware_custom.cairo.stark_verifier.air.layouts.recursive.public_verify import (
    get_layout_builtins,
    segments,
)
from starkware_custom.cairo.stark_verifier.air.layouts.recursive.verify import verify_proof
from starkware_custom.cairo.stark_verifier.air.public_input import PublicInput, SegmentInfo
from starkware_custom.cairo.stark_verifier.air.public_memory import AddrValue
from starkware_custom.cairo.stark_verifier.core.stark import StarkProof
...
func main{
    ...
    %{
        from starkware_custom.cairo.stark_verifier.air.parser import parse_proof
